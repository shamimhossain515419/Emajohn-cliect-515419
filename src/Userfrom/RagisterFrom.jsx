...
import RagiserLottianimation  from '../../public/86974-registration.json'
const RagisterFrom = () => {
     ...
     const onSubmit = data => {
          ...
          Singup(data.email, data.password).then(result => {
               console.log(result.user);
               updateProfile(auth.currentUser, {
                    displayName: name, photoURL: data.profile
               }).then((result) => {
                    console.log(result);
     ...
     return (
          ...
          <div className=' grid md:grid-cols-2 justify-center items-center  ju mt-4 gap-8'>
           <div className=' overflow-hidden '>

               <video loop="loop"  muted  onPlay={true}>
                 <source data-v-15d00138=""  type="video/mp4" src="https://cdnl.iconscout.com/lottie/premium/thumb/woman-checking-to-do-list-5840272-4915651.mp4" />
         </video>
               </div>
               ...
               <div className='  mt-8 shadow-xl p-3 '>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                         ...
                         <div >
                              <h1 className=' text-center text-4xl font-semibold  text-[#b300dc]'> Ragister Now</h1>
                              <div className="grid grid-cols-1  mt-5">
                                   <div className=' flex gap-4  '>
                                        <div className=' w-full my-2 '>
                                             <input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                                  defaultValue="" {...register("name")} placeholder='fist Name*' />
                                        </div>
                                        <div className=' w-full my-2 '>
                                             <input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                                  defaultValue="" {...register("lastName")} placeholder='Last Name*' />
                                        </div>
                                   </div>
                                   <div className=' my-2'>
                                        <input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                   ...
                                   <div className=' my-2'>
                                        <input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                                             defaultValue="" {...register("profile")} placeholder='ProfileURl' />
                                   </div>
                    ...
                    <div className=' flex items-center text-xl  justify-center'>
                         ...
                         <Link className=' text-blue-500 font-normal ml-2' to={'/login'}>Login In</Link>
                    </div>
               </div>
          </div>
     );
