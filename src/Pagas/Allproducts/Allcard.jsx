...
const Allcard = ({ product,HandleAddCard }) => {
     ...
     return (
          <div className=" relative shadow-lg cursor-pointer  rounded-xl overflow-hidden ">
               ...
               <button  onClick={()=> HandleAddCard(product)} className="   absolute bottom-2     bg-yellow-500 text-white py-1 px-4 rounded-md block w-full"> Add Card</button>
          </div>
     );
};
